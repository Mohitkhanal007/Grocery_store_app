...
import 'package:grocerystore/features/auth/data/data_source/local_datasource/user_local_datasource.dart';
...
import 'package:grocerystore/features/product/data/data_source/remote_datasource/product_remote_datasource.dart';
import 'package:grocerystore/features/product/data/repository/product_repository_impl.dart';
...
import 'package:grocerystore/features/category/data/repository/category_repository_impl.dart';
...
Future<void> _initAuthModule() async {
  ...
  serviceLocator.registerLazySingleton<UserLoginUsecase>(
    () => UserLoginUsecase(
      ...
      sharedPreferences: serviceLocator<SharedPreferences>(),
      cartViewModel: serviceLocator<CartViewModel>(),
    ),
  );
